...
JWT_AUTH = {
    "JWT_GET_USER_SECRET_KEY": "social_media_api.authentication.services.auth_user_get_jwt_secret_key",
    "JWT_RESPONSE_PAYLOAD_HANDLER": "social_media_api.authentication.services.auth_jwt_response_payload_handler",
